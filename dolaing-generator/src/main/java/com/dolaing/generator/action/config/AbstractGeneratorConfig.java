package com.dolaing.generator.action.config;
...
import com.dolaing.core.util.FileUtil;
import com.dolaing.generator.engine.SimpleTemplateEngine;
import com.dolaing.generator.engine.base.DolaingTemplateEngine;
import com.dolaing.generator.engine.config.ContextConfig;
import com.dolaing.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doDolaingGeneration() {
        DolaingTemplateEngine DolaingTemplateEngine = new SimpleTemplateEngine();
        DolaingTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        DolaingTemplateEngine.setSqlConfig(sqlConfig);
        DolaingTemplateEngine.setTableInfo(tableInfo);
        DolaingTemplateEngine.start();
    }
}
