package com.dolaing.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "dolaingTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\dolaing";//模板输出的项目目录
    ...
    private String proPackage = "com.dolaing.admin";
    private String coreBasePackage = "com.dolaing.core";
    private String modelPackageName = "com.dolaing.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.dolaing.modular.system.dao";    //model的dao
