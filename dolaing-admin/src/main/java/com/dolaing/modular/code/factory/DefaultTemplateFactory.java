package com.dolaing.modular.code.factory;


import com.dolaing.DolaingApplication;
import com.dolaing.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("dolaing");
        genQo.setProjectPackage(DolaingApplication.class.getPackage().getName());
