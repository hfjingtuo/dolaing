...
import com.dolaing.modular.system.service.IDictService;
...
import static com.dolaing.core.common.constant.factory.MutiStrFactory.*;
    ...
    public void addDict(String dictCode,String dictName,String dictTips, String dictValues) {
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new DolaingException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
