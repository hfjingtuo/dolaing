...
import com.dolaing.core.common.constant.dictmap.MenuDict;
...
import com.dolaing.core.node.ZTreeNode;
import com.dolaing.core.support.BeanKit;
import com.dolaing.core.util.ToolUtil;
import com.dolaing.modular.system.model.Menu;
import com.dolaing.modular.system.service.IMenuService;
import com.dolaing.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new DolaingException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new DolaingException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
