...
public class MallGoods extends BaseModel<MallGoods> {
    ...
    private String isOnSale ;// 是否上架(0不上架 1上架),
    private String depositRatio ;// 定金比例,
    private String isFreeShipping ;//是否包邮(0不包邮 1包邮),
    ...
    private String startPlantime ;//种植开始时间,
    private String endPlantime ;//种植完成时间,
    ...
    private String expectDeliverTime ;//预计发货时间,
    ...
    private String startSubscribeTime ;//开始认购时限,
    private String endSubscribeTime ;//结束认购时限,
