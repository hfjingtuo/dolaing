package com.dolaing.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.dolaing.core.config.properties.DruidProperties;
import com.dolaing.core.config.properties.MutiDataSourceProperties;
import com.dolaing.core.datascope.DataScopeInterceptor;
import com.dolaing.core.mutidatasource.DynamicDataSource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "dolaing.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.dolaing.modular.*.dao","com.dolaing.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "dolaing.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourceDolaing);
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[1], bizDataSource);
        dynamicDataSource.setTargetDataSources(hashMap);
        dynamicDataSource.setDefaultTargetDataSource(dataSourceDolaing);
